...
import { Eye, EyeOff, Globe2, LockKeyhole, Mail, ShieldCheck } from "lucide-react";
...
function getAuthErrorMessage(error: unknown, t: (key: LocaleKey) => string) {
      ...
      <Card className="w-full max-w-[440px] rounded-2xl border-[#E8EAED] bg-white p-6 shadow-[0_24px_70px_rgba(31,41,55,0.12)] sm:p-8">
        ...
        {checkingSession ? (
          <div className="mt-8 grid place-items-center gap-3 py-10">
            ...
            <p className="text-sm font-semibold text-[#6B7280]">{t("login.checking")}</p>
          </div>
        ) : (
          <form className="mt-8 space-y-5" onSubmit={submit}>
            ...
            <label className="block">
              <span className="text-sm font-semibold text-[#55565A]">{t("login.password")}</span>
