...
CREATE UNIQUE INDEX `business_targets_exact_version_unique` ON `business_targets` (`company_id`,`target_year`,`target_month`,`metric`,`product_group`,`branch_id`,`salesperson_id`,`source_version`);--> statement-breakpoint
