...
const my: Record<keyof typeof en, string> = {
  ...
  "daily.reportInfoDescription": "ယနေ့ report အတွက် ရက်စွဲ၊ နယ်ပယ်နှင့် target ကို သတ်မှတ်ပါ",
  ...
  "daily.lifecycleAutomatic": "Wait Approve, Wait Delivery, Delivered နှင့် Cancel ကို Booking Data Hub မှ တွက်ချက်ပါသည်။ ထပ်ဖြည့်ရန် မလိုပါ။",
